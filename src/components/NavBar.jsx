...
const NavBar = () => {
  ...
  const navContainerReference = useRef(null);
  ...
  useEffect(() => {
    if (currentScrollY === 0) {
      ...
      navContainerReference.current.classList.remove("floating-nav");
    } else if (currentScrollY > lastScrollY) {
      setIsNavVisible(false);
      navContainerReference.current.classList.add("floating-nav");
    } else if (currentScrollY < lastScrollY) {
      setIsNavVisible(true);
      navContainerReference.current.classList.add("floating-nav");
    }
